...
var TableFilterComponent = /** @class */ (function () {
    function TableFilterComponent(dialog) {
        var _this = this;
        this.dialog = dialog;
        this.rows = [];
        this.temp = [];
