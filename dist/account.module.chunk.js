...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(authService, fb, router, snackBar) {
        ...
        this.config = new __WEBPACK_IMPORTED_MODULE_5__angular_material__["H" /* MatSnackBarConfig */]();
    ...
    SigninComponent.prototype.onSubmit = function () {
        ...
        this.authService.login(postData).subscribe(function (data) {
            ...
            _this.snackBar.open("Welcome " + data['profile'].username, '', _this.config);
    ...
    SigninComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormBuilder"], __WEBPACK_IMPORTED_MODULE_1__angular_router__["f" /* Router */], __WEBPACK_IMPORTED_MODULE_5__angular_material__["G" /* MatSnackBar */]])
    ], SigninComponent);
